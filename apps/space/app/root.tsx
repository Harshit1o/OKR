...
const APP_TITLE = "ScaleX Publish | Make your ScaleX boards public with one-click";
const APP_DESCRIPTION = "ScaleX Publish is a customer feedback management tool built on top of scalex.example";
...
export const meta: Route.MetaFunction = () => [
  ...
  { property: "og:url", content: "https://scalex.example/" },
  {
    name: "keywords",
    content:
