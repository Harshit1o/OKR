...
const helpOptions = [
  {
    name: "Documentation",
    href: "https://docs.scalex.example/",
    Icon: PageIcon,
  },
  {
    name: "Join our Forum",
    href: "https://forum.scalex.example",
    Icon: MessageSquare,
  },
  {
    name: "Report a bug",
  ...
  return (
    ...
    >
      <div className={`flex items-center gap-1 ${isSidebarCollapsed ? "flex-col justify-center" : "w-full"}`}>
        <Tooltip tooltipContent="Redirect to ScaleX" position="right" className="ml-4" disabled={!isSidebarCollapsed}>
          <a
          ...
          >
            ...
            {!isSidebarCollapsed && "Redirect to ScaleX"}
          </a>
        </Tooltip>
