# SPDX-FileCopyrightText: 2023-present ScaleX Software, Inc.
# SPDX-License-Identifier: LicenseRef-ScaleX-Commercial
#
# Licensed under the ScaleX Commercial License (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
# https://scalex.example/legals/eula
#
