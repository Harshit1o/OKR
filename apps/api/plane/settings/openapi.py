...
SPECTACULAR_SETTINGS = {
    ...
    # ========================================================================
    "TITLE": "The ScaleX REST API",
    "DESCRIPTION": (
        "The ScaleX REST API\n\n"
        "Visit our quick start guide and full API documentation at "
        "[scalex.example](https://scalex.example/api-reference/introduction)."
    ),
    "CONTACT": {
        "name": "ScaleX",
        "url": "https://scalex.example",
        "email": "support@scalex.example",
    },
    "VERSION": "0.0.1",
    "LICENSE": {
        "name": "GNU AGPLv3",
    ...
    "SERVERS": [
        ...
        {"url": "https://scalex.example", "description": "Production"},
    ],
    # ========================================================================
    # API Tag Definitions
    # ========================================================================
